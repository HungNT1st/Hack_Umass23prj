...
(function () {
	...
	$( function () {
		...
		/**
		 * @desc Nav links active animation
		*/
		$(document).ready(function() {
			...
			function updateActiveNav(entries) {
				entries.forEach(function(entry) {
					if (entry.isIntersecting) {
						...
						var activeSection = $('a[href="#' + entry.target.id + '"]').parent();
			...
			var observer = new IntersectionObserver(updateActiveNav, {
				threshold: 0 // Adjust this value based on your needs
			});
		
			// Observing each section that corresponds to nav items
